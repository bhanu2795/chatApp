                            ...
                            <View style={{ marginTop: 20, marginBottom: 20, alignItems: 'flex-start' }}>
                                <View style={{ width: '100%', flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center', borderBottomColor: '#d3d3d3', borderBottomWidth: 1 }}>
                                    ...
                                    <View style={{ padding: 5, paddingTop: 20, paddingBottom: 15 }}>
                                        <Input placeholder={'User Id'} newStyles={styles.phoneInput} secureTextEntry={false} autoFocus={true} maxLength={10} blurOnSubmit={false} returnKeyType={'next'} onSubmitEditing={() => this.textInput['pass'].focus()} />
                                    </View>
                                </View>
